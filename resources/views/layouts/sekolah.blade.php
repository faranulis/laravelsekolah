...
<head>
	...
	<link rel="stylesheet" href="{{ asset('sekolah/assets/css/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ asset('sekolah/assets/css/atlantis.min.css') }}">
	<link href="{{ asset('sekolah/doc/assets/styles.css') }}" rel="stylesheet" />
	<link href="{{ asset('sekolah/doc/assets/prism.css') }}" rel="stylesheet" />
		...
		<div class="main-header">
			<div class="logo-header" data-background-color="light-blue2">
				<a href="index.html" class="logo">
					<img src="{{ asset('sekolah/assets/img/logo.svg') }}" alt="navbar brand" class="navbar-brand">
				</a>
...
<script src="{{ asset('sekolah/assets/js/core/jquery.3.2.1.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/core/popper.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/core/bootstrap.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/chart.js/chart.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('sekolah/assets/js/plugin/jqvmap/jquery.vmap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('sekolah/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js') }}" charset="utf-8"></script>
<script src="{{ asset('sekolah/assets/js/plugin/chart-circle/circles.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js') }}"></script>
<script src="{{ asset('sekolah/assets/js/atlantis.min.js') }}"></script>
<script src="{{ asset('sekolah/doc/assets/prism.js') }}"></script>
<script src="{{ asset('sekolah/doc/assets/prism-normalize-whitespace.min.js') }}"></script>
